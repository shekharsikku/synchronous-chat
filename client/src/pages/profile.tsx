...
const Profile = () => {
  ...
  const [{ isUpdating, selectedImage, imageFormData, isPasswordOpen, isConfirmOpen, isDeleteOpen }, dispatch] =
              ...
              <ContextMenuContent className="w-20 flex flex-col gap-2 p-2 transition-all duration-300 text-gray-950 dark:text-gray-50">
                {userInfo?.image && (
                  <ContextMenuItem
                    ...
                    onClick={() => dispatch({ type: "TOGGLE_DELETION_MODAL", payload: true })}
                  >
          ...
          <div className="hidden lg:flex gap-6 w-full items-center justify-center">
            <TooltipElement content="Chat Messages" asChild>
              <Button
                ...
                disabled={isUpdating || !userInfo?.setup}
              >
            ...
            <TooltipElement content="Sign Out" asChild>
              <Button size="sm" className="w-full" onClick={handleSignOut} disabled={isUpdating}>
        ...
        <div className="flex-1 flex flex-col gap-2 lg:gap-4 items-center justify-start lg:justify-center">
          <Form {...profileUpdateForm}>
            ...
            >
              ...
              />
              <Button type="submit" size="lg" className="w-full cursor-pointer mt-2 lg:mt-1" disabled={isUpdating}>
                Save Changes
              </Button>
            </form>
          </Form>
